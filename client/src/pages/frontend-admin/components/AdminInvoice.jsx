...
const AdminInvoice = ({ order, onClose, isModal = false }) => {
  ...
  useEffect(() => {
    // For admin, we already have complete order data from the admin orders API
        ...
        <div className="bg-purple-50 p-4 rounded-lg border border-purple-200">
          ...
          <p className="font-bold text-purple-900 capitalize">
            {orderData.payment_method === 'cod' ? 'Cash on Delivery' : 
             orderData.payment_method === 'benefit' ? 'Benefit Pay' :
      ...
      <div className="border-t-2 border-gray-200 pt-6">
        ...
        <div className="text-center mt-6 pt-4 border-t border-gray-200">
          ...
          <p className="text-xs text-gray-400 mt-1">
            Admin Panel - Invoice #{generateInvoiceNumber(orderData.order_id)}
          </p>
        </div>
      </div>
    </div>
      ...
      <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
        <div className="bg-white rounded-2xl shadow-2xl max-w-5xl w-full max-h-[90vh] overflow-y-auto">
          ...
          <div className="sticky top-0 bg-white border-b border-gray-200 p-4 flex items-center justify-between rounded-t-2xl">
            <h2 className="text-xl font-bold text-gray-800">Invoice Preview - Admin Panel</h2>
            <div className="flex items-center gap-3">
              <button
                onClick={downloadPDF}
    ...
    <div className="min-h-screen bg-gray-100 py-8">
      <div className="container mx-auto px-4">
        ...
        <div className="flex items-center justify-between mb-6">
          <h1 className="text-2xl font-bold text-gray-800">Invoice - Admin Panel</h1>
          <div className="flex items-center gap-3">
            <button
              onClick={downloadPDF}
              disabled={isGenerating}
