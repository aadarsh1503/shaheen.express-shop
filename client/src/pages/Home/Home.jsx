...
// This component now includes the hover-to-show action buttons.
const ProductCard = ({ product }) => {
  return (

    <div className="text-center group"> {/* Added group here to control button visibility */}
    
      <div className="relative overflow-hidden border-b-2 border-teal-500 group-hover:border-teal-500 transition-colors duration-300 pb-2">
        ...
        <div className="relative w-full aspect-square bg-white flex items-center justify-center">
          ...
          <div className="absolute bottom-4 left-1/2 -translate-x-1/2 flex items-center
            ...
            <div className="flex bg-white rounded-md shadow-lg overflow-hidden">
                <button className="p-3 text-gray-600 hover:bg-gray-100 hover:text-black transition-colors" title="Add to Cart">
      ...
      <div className="mt-4">
        ...
        <div className="mt-2 flex items-center justify-center space-x-2">
          ...
          {product.inStock ? (
            <span className="text-teal-600 text-sm border border-teal-300 rounded-full px-3 py-0.5">
              In stock
            </span>
          ) : (
  ...
  return (
    <div className="font-sans bg-gray-50 min-h-screen">
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        {/* Header Section: Breadcrumbs and Controls */}
